...
namespace MS_Back_Maps.Data
{
    public class MapsContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Data Source=MSI\SQLEXPRESS;Initial Catalog=MS_Maps;Persist Security Info=True;User ID=daniil;Password=test;Trust Server Certificate=True");
        }
    }
}
